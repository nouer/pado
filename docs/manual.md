...
各カードの「詳細」ボタンをクリックすると、取引先情報の詳細をオーバーレイで確認できます。読み取り専用の一覧表示で、登録内容を素早く確認できます。

![取引先詳細表示](images/14_partner_detail.png)

詳細オーバーレイの「編集」ボタンをクリックすると、そのまま編集フォームに遷移できます。
...
テーブル内の「詳細」ボタンをクリックすると、品目情報の詳細をオーバーレイで確認できます。

![品目詳細表示](images/15_item_detail.png)
...
[**活用事例を見る →**](usecases_showcase.html) — 実際の業務での活用シーンをご紹介
